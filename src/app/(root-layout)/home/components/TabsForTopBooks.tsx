            ...
            <div className="flex flex-col justify-center items-center">
                <Tabs selectedKey={active} onSelectionChange={setActive} aria-label="Options" color='primary'>
                    ...
                    <Tab key="music" title="Music">
                        <div className="w-full grid lg:gap-14 mt-7 grid-cols-2 ">
                            {

                                books.map((book) => <div
                                    key={book._id}
                                    className="relative gap-3 p-2 border border-primary group overflow-hidden flex">
                                    <div className="">
                                        <Image className='h-[250px] w-[160px]' src={book.img} width={350} height={500} alt={'image of ' + book.title + 'book'} />
                                    </div>
                                    <div className="text-gray-500 max-w-[250px] h-full relative w-full">
                                        <h1 className='text-4xl text-black font-bold uppercase font-Bebas_Neue'>{book.title}</h1>
